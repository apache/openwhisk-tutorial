...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'whisk_tutorial_tutorialuser', (
        ...
        db.send_create_signal(u'whisk_tutorial', ['TutorialUser'])

        # Adding model 'TutorialEvent'
        db.create_table(u'whisk_tutorial_tutorialevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'whisk_tutorial', ['TutorialEvent'])


    def backwards(self, orm):
        # Deleting model 'TutorialUser'
        db.delete_table(u'whisk_tutorial_tutorialuser')

        # Deleting model 'TutorialEvent'
        db.delete_table(u'whisk_tutorial_tutorialevent')
