...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'whisk_tutorial_subscriber', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=80)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whisk_tutorial.TutorialUser'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('from_level', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'whisk_tutorial', ['Subscriber'])

        # Adding unique constraint on 'Subscriber', fields ['email', 'from_level']
        db.create_unique(u'whisk_tutorial_subscriber', ['email', 'from_level'])

        # Adding model 'DockerfileEvent'
        db.create_table(u'whisk_tutorial_whiskfileevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whisk_tutorial.TutorialUser'])),
        ...
        db.send_create_signal(u'whisk_tutorial', ['DockerfileEvent'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subscriber', fields ['email', 'from_level']
        db.delete_unique(u'whisk_tutorial_subscriber', ['email', 'from_level'])

        # Deleting model 'Subscriber'
        db.delete_table(u'whisk_tutorial_subscriber')

        # Deleting model 'DockerfileEvent'
        db.delete_table(u'whisk_tutorial_whiskfileevent')
