...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'whisk_tutorial_tutorialuser', 'http_user_agent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'TutorialUser.http_remote_address'
        db.add_column(u'whisk_tutorial_tutorialuser', 'http_remote_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'TutorialUser.http_accept_language'
        db.add_column(u'whisk_tutorial_tutorialuser', 'http_accept_language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'TutorialUser.http_accept_encoding'
        db.add_column(u'whisk_tutorial_tutorialuser', 'http_accept_encoding',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'TutorialUser.http_referrer'
        db.add_column(u'whisk_tutorial_tutorialuser', 'http_referrer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


        # Changing field 'TutorialUser.label'
        db.alter_column(u'whisk_tutorial_tutorialuser', 'label', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):
        # Deleting field 'TutorialUser.http_user_agent'
        db.delete_column(u'whisk_tutorial_tutorialuser', 'http_user_agent')

        # Deleting field 'TutorialUser.http_remote_address'
        db.delete_column(u'whisk_tutorial_tutorialuser', 'http_remote_address')

        # Deleting field 'TutorialUser.http_accept_language'
        db.delete_column(u'whisk_tutorial_tutorialuser', 'http_accept_language')

        # Deleting field 'TutorialUser.http_accept_encoding'
        db.delete_column(u'whisk_tutorial_tutorialuser', 'http_accept_encoding')

        # Deleting field 'TutorialUser.http_referrer'
        db.delete_column(u'whisk_tutorial_tutorialuser', 'http_referrer')


        # Changing field 'TutorialUser.label'
        db.alter_column(u'whisk_tutorial_tutorialuser', 'label', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
